...
export const decants: Decant[] = [
  ...
  },
  {
    ...
    isNew: true,
    variants: [
      { size: 3, price: 160, stock: 10 },
      { size: 5, price: 230, stock: 6 },
      { size: 10, price: 430, stock: 6 }
    ]
  },
  {
...
/*   {
    ...
    perfumeId: 'jpg_le_male_elixir',
    tipo: 'decant',
    image: '/assets/images/fragancias/decants-all-size.webp',
    images: [
      '/assets/images/fragancias/decants-all-size.webp',
      '/assets/images/fragancias/decants-all-size.webp',
      '/assets/images/fragancias/decants-all-size.webp'],
    ...
    variants: [
      ...
      { size: 5, price: 200, stock: 0 },
      { size: 10, price: 360, stock: 0 }
    ]
  }, */
  // ...otros decants...
];
