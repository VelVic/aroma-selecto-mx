...
const ProductFilters: React.FC<ProductFiltersProps> = ({
  ...
  return (
    <>
      ...
      <aside className="hidden lg:block w-full lg:w-64 bg-white rounded-lg shadow p-6 mb-8 lg:mb-0 lg:h-[calc(100vh-5rem)] lg:overflow-auto lg:pr-4 lg:pl-2">
      ...
      {filtersOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-40">
          <div className="bg-white rounded-lg shadow-lg p-6 w-full max-w-xs mx-auto relative">
            <button
              className="absolute top-2 right-2 text-gray-500 hover:text-[#D4AF37] text-xl"
            ...
            <button
              className="w-full mt-2 py-2 bg-[#D4AF37] text-white rounded font-semibold"
              onClick={() => setFiltersOpen(false)}
            >
              Aplicar filtros
            </button>
